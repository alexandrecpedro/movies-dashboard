CREATE OR REPLACE VIEW `netflix-pipeline-491410.views_data.vw_scatter_popularity_vs_quality`
(
...
AS (
  SELECT
    ...
    totalRatings,
    avgRating
  FROM `netflix-pipeline-491410.gold_data.scatter_popularity_vs_quality`
);
